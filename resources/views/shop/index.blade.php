...
<div class="container my-5">
    ...
    <div class="text-center mb-5">
        <h1 class="fw-bold display-6 mb-3 text-dark">Temukan Event Menarikmu</h1>
        <p class="text-muted fs-5">Jelajahi berbagai konser, festival, workshop, dan pengalaman tak terlupakan 🎟️</p>
    </div>
