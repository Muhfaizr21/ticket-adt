...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.payment_methods.update', $method->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 bank-field" style="display:none;">
            ...
            <input type="text" name="account_number" id="account_number" class="form-control" value="{{ old('account_number', $method->account_number) }}">
        </div>

        <div class="mb-3 bank-field" style="display:none;">
            <label for="account_name" class="form-label">Nama Pemilik Rekening</label>
            <input type="text" name="account_name" id="account_name" class="form-control" value="{{ old('account_name', $method->account_name) }}">
        </div>
        ...
        <div class="mb-3 qris-field" style="display:none;">
            ...
            @if($method->qr_code_image)
                <div class="mb-2">
                    <img src="{{ asset('storage/' . $method->qr_code_image) }}" alt="QR Code" width="80">
                </div>
            @endif
